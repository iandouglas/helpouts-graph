...
function initcharts() {
  ...
  $("#infodiv")
    .filtercount();
  dashboard.map = $("#map")
    .filtermap(dashboard.config.maps[0]);
  $(".leaflet-control-layers-base")
    .addClass("radio");
  dashboard.modal = $("#responsemodal")
    .responsemodal();
  dashboard.photopanel = $("#photopanel")
    .photopanel(dashboard.config.photo);
  $("#buttonpanel button")
...
(function ($) {
  $.fn.filtermap = function (options) {
    ...
    var markerlayer = buildmarkerlayer(options)
      .setmap(mymap);
...
(function ($) {
  $.fn.photopanel = function (options) {
    ...
    function fixanchors() {
      currentpage == 0 ? $("#prevthumbs")
        .hide() : $("#prevthumbs")
        .show();
      currentpage == pages.length - 1 ? $("#nextthumbs")
        .hide() : $("#nextthumbs")
        .show()
    }
    ...
    function updatepictures() {
      ...
      function imgerror() {
        $(this)
          .attr("src", "images/photothumb.jpg")
      }
      if (!$("#imagelist")
        .is(":empty")) {
        $("#imagelist")
...
(function ($) {
  $.fn.responsemodal = function (options) {
    ...
    function showmodal(d) {
      ...
      $("#responsemodal .modal-header h3")
        .text(modaltitle.substring(0, 30));
      $("#resphoto")
        .attr("src", "images/loading1.gif");
      $("#resphoto")
        .attr("src", oh.getimageurl(d));
      $("#responsemodal")
        .modal();
